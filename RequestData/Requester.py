...
class PlaywrightRequester(AbstractRequester):
    ...
    def __init__(self, user: User.AbstractUser, is_debug: bool = False) -> None:
        ...
        self.timetable_page: str = self.request_timetable_page()

    @Decorator.RunTimeMonitor("PlaywrightRequester: get_timetable_html")
    def get_timetable_html(self) -> str:
        return self.timetable_page

    @Decorator.RunTimeMonitor("PlaywrightRequester: request_timetable_page")
    def request_timetable_page(self) -> str:
        """
    ...
    @Decorator.RunTimeMonitor("PlaywrightRequester: run")
