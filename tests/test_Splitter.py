...
class SplitterTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.records: list[list[str]] = [['2',
                                         ...
                                         ['null',
                                          ...
                                          '0',
                                          '0']]
        self.data: list[list[str]] = [self.header] + self.records
        self.excepted: list[list[str]] = [['Sem',
                                           'Class Code',
                                           'Learning Module',
                                           'Instructor',
                                           'Venue',
    ...
    def test_PeriodSplitter(self) -> None:
        splitter = Splitter.PeriodSplitter(self.data)
        result = splitter.get_data()
        self.assertEqual(result, self.excepted)
